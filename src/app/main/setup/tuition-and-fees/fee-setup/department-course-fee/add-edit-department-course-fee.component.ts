...
@Component({
  selector: 'o-add-edit-department-course-fee',
  templateUrl: './../add-edit-fee.component.html',

  styles: [],
})
export class AddEditDepartmentCourseFeeComponent
  ...
  implements OnInit
{
  constructor(
    ...
    this.getFormFields(
      this.formBuilder,
      this.apiService,
      this.createUrl('fee/department-course-fee-fields', feeId)
    )
  ...
  saveFee() {
    if (super.saveFee()) {
      ...
      value.levelCourseFeeId = this.data.feeId;
      ...
      console.log(value);
      this.apiService
        .post('fee/save-department-course-fee', value)
        .pipe(take(1))
        .subscribe((data) => {
