...
@Component({
  selector: 'o-add-edit-department-fee',
  templateUrl: './../add-edit-fee.component.html',

  styles: [],
})
export class AddEditDepartmentFeeComponent
  ...
  implements OnInit
{
  constructor(
    ...
    this.getFormFields(
      this.formBuilder,
      this.apiService,
      this.createUrl('fee/department-fee-fields', feeId)
    )
  ...
  saveFee() {
    if (super.saveFee()) {
      ...
      value.departmentFeeId = this.data.feeId;
      ...
      console.log(value);
      this.apiService
        .post('fee/save-department-fee', value)
        .pipe(take(1))
        .subscribe((data) => {
