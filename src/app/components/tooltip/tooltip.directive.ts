...
export class TooltipDirective {
  ...
  @Input('options') set options(value: TooltipOptionInfo) {
  ...
  @Input('oTooltip') tooltipValue: string | null = null;
  ...
  get destroyDelay() {
    if (this._destroyDelay) {
      ...
      return (
        Number(this.getHideDelay()) + Number(this.options['animationDuration'])
      );
    }
  }
  ...
  createTooltip(): void {
    ...
    this.createTimeoutId = window.setTimeout(() => {
      this.appendComponentToBody(TooltipComponent, { theme: this.theme });
    }, this.getShowDelay());
  ...
  appendComponentToBody(component: any, data: any = {}): void {
    ...
    this.componentSubscribe = (<AdComponent>(
